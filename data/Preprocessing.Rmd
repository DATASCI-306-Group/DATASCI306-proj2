...
NAME_BASICS <- read_rds("/cloud/project/data/name_basics.rda")
TITLE_BASICS <- read_rds("/cloud/project/data/title_basics.rda")
TITLE_PRINCIPALS <- read_rds("/cloud/project/data/title_principals.rda")
TITLE_RATINGS <- read_rds("/cloud/project/data/title_ratings.rda")
